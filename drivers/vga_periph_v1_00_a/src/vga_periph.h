/*****************************************************************************
* Filename:          C:\materija\ra1802013\lprs2\Vezba3\project/drivers/vga_periph_v1_00_a/src/vga_periph.h
* Version:           1.00.a
...
#define VGA_PERIPH_SLV_REG16_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000040)
#define VGA_PERIPH_SLV_REG17_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000044)
#define VGA_PERIPH_SLV_REG18_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000048)
#define VGA_PERIPH_SLV_REG19_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x0000004C)
#define VGA_PERIPH_SLV_REG20_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000050)
#define VGA_PERIPH_SLV_REG21_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000054)
#define VGA_PERIPH_SLV_REG22_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000058)
#define VGA_PERIPH_SLV_REG23_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x0000005C)
#define VGA_PERIPH_SLV_REG24_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000060)
#define VGA_PERIPH_SLV_REG25_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000064)
#define VGA_PERIPH_SLV_REG26_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000068)
#define VGA_PERIPH_SLV_REG27_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x0000006C)
#define VGA_PERIPH_SLV_REG28_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000070)
#define VGA_PERIPH_SLV_REG29_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000074)
#define VGA_PERIPH_SLV_REG30_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x00000078)
#define VGA_PERIPH_SLV_REG31_OFFSET (VGA_PERIPH_USER_SLV_SPACE_OFFSET + 0x0000007C)
...
#define VGA_PERIPH_mWriteSlaveReg16(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG16_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg17(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG17_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg18(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG18_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg19(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG19_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg20(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG20_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg21(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG21_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg22(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG22_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg23(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG23_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg24(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG24_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg25(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG25_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg26(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG26_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg27(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG27_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg28(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG28_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg29(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG29_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg30(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG30_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_PERIPH_mWriteSlaveReg31(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_PERIPH_SLV_REG31_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define VGA_PERIPH_mReadSlaveReg16(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG16_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg17(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG17_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg18(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG18_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg19(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG19_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg20(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG20_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg21(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG21_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg22(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG22_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg23(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG23_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg24(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG24_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg25(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG25_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg26(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG26_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg27(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG27_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg28(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG28_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg29(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG29_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg30(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG30_OFFSET) + (RegOffset))
#define VGA_PERIPH_mReadSlaveReg31(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_PERIPH_SLV_REG31_OFFSET) + (RegOffset))
