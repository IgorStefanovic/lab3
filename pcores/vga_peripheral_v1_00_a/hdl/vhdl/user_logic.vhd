...
-- Date:              Thu Apr 07 13:38:33 2016 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  signal slv_reg_enable						 : std_logic;
...
begin
  ...
  slv_reg_write_sel <= Bus2IP_WrCE(31 downto 0) when (slv_reg_enable = '1') else
								(others => '0');

  slv_reg_read_sel  <= Bus2IP_RdCE(31 downto 0) when (slv_reg_enable = '1') else
								(others => '0');
  ...
  begin
	...
	-- NASAPROM
	char_we <= '1' when Bus2IP_Addr(25 downto 24) = "01" else '0';
	pixel_we <= '1' when Bus2IP_Addr(25 downto 24) = "10" else '0';
	slv_reg_enable <= '1' when Bus2IP_Addr(25 downto 24) = "00" else '0';
	
	
	char_address <= Bus2IP_Addr(31 downto 0) when char_we = '1' 
		else (others => '0');
		
	pixel_address <= Bus2IP_Addr(31 downto 0) when pixel_we = '1' 
		else (others => '0');
		
	slv_ip2bus_data <= Bus2IP_Addr(31 downto 0) when slv_reg_enable = '1' 
		else (others => '0');
